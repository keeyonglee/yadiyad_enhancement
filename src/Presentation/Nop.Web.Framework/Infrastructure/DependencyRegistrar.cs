...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<VendorApplicationService>().As<IVendorApplicationService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<VendorAttributeValueParser>().As<IVendorAttributeValueParser>().InstancePerLifetimeScope();
