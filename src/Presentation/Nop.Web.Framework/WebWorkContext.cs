...
namespace Nop.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        public decimal? Longitude
        {
            get
            {
                var longitude = _httpContextAccessor.HttpContext?.Session.Get<decimal?>("Customer.Longitude");

                return longitude;
            }
            set
            {
                 _httpContextAccessor.HttpContext?.Session.Set<decimal?>("Customer.Longitude", value);
            }
        }
        ...
        public decimal? Latitude
        {
            get
            {
                var longitude = _httpContextAccessor.HttpContext?.Session.Get<decimal?>("Customer.Latitude");

                return longitude;
            }
            set
            {
                _httpContextAccessor.HttpContext?.Session.Set<decimal?>("Customer.Latitude", value);
            }
        }
