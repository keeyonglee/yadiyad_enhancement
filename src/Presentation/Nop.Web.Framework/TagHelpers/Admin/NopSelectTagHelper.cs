...
namespace Nop.Web.Framework.TagHelpers.Admin
{
    ...
    public class NopSelectTagHelper : TagHelper
    {
        ...
        private const string MultipleSelectAttributeName = "asp-multiple";
        ...
        /// </summary>
        [HtmlAttributeName(MultipleSelectAttributeName)]
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            foreach (var attribute in attributes)
            {
                if (!attribute.Name.Equals(ForAttributeName) &&
                    ...
                    !attribute.Name.Equals(MultipleSelectAttributeName) &&
            ...
            bool.TryParse(IsDisabled, out bool isDisabled);
