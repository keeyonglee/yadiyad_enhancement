...
namespace Nop.Web.Framework.TagHelpers.Admin
{
    ...
    public class NopEditorTagHelper : TagHelper
    {
        ...
        private const string CustomUploadUrlAttributeName = "asp-custom-upload-url";
        private const string ShowIconAttributeName = "asp-showicon";
        ...
        /// Indicates whether the field is required
        /// </summary>
        [HtmlAttributeName(CustomUploadUrlAttributeName)]
        public string CustomUploadUrl { set; get; }

        /// <summary>
        /// Indicates whether the field is required
        /// </summary>
        [HtmlAttributeName(ShowIconAttributeName)]
        public string ShowIcon { set; get; }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //set value if exists
            if (!string.IsNullOrEmpty(CustomUploadUrl))
                htmlAttributes.Add("custom-upload-url", CustomUploadUrl);

            //set value if exists
            if (!string.IsNullOrEmpty(ShowIcon))
                htmlAttributes.Add("asp-showicon", ShowIcon);
