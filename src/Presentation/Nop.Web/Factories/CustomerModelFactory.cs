    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
            ...
            bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
        {
            ...
            if (_customerService.IsVendor(customer))
            {
                ...
                model.Category = _categoryService.GetCategoryById(vendor.CategoryId.Value)?.Name ?? "";
                model.Online = _vendorService.GetVendorOnlineStatus(vendor);
                model.OfflineUntil = vendor.OfflineUntil;
            }
        ...
        public virtual CustomerNavigationModel PrepareCustomerNavigationModel(int selectedTabId = 0)
        {
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                RouteName = "CustomerBankAccount",
                Title = _localizationService.GetResource("Account.BankAccount"),
                Tab = CustomerNavigationEnum.BankAccount,
                ItemClass = "customer-bank-account"
            });
            ...
            if (_orderSettings.ReturnRequestsEnabled &&
                _returnRequestService.SearchReturnRequests(0, _storeContext.CurrentStore.Id,
