...
namespace Nop.Web.Factories
{
    public partial class CheckoutModelFactory : ICheckoutModelFactory
    {
        ...
        public virtual CheckoutConfirmModel PrepareConfirmOrderModel(IList<ShoppingCartItem> cart)
        {
            ...
            var vendorShippings = _orderTotalCalculationService.GetShoppingCartShippingTotalPerVendor(cart);

            model.NotInsideCoverage = vendorShippings.Any(x => x.NotInsideCoverage);
            model.FailComputeShipping = vendorShippings.Any(x => x.FailComputeShipping);
            model.ShipmentOverweight = vendorShippings.Any(x => x.ShipmentOverweight);
        ...
        public virtual CheckoutCompletedModel PrepareMasterCheckoutCompletedModel(MasterOrder order)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
