...
namespace Nop.Web.Factories
{
    ...
    public partial interface IProductModelFactory
    {
        ...
        ProductDetailsModel PrepareProductDetailsModel(Product product, ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false, bool isAdditionalProduct = false);
        PictureModel PrepareProductDetailsPictureModel(Product product, bool isAssociatedProduct, out IList<PictureModel> allPictureModels);
        /// <summary>
        ...
        ProductReviewsModel PrepareProductReviewsModel(ProductReviewsModel model, Product product, int? page = 0);
        IList<ProductReviewModel> PrepareProductReviewModel(IList<ProductReviewModel> model,
        ...
        PictureModel PrepareProductOverviewPictureModel(Product product, int? productThumbPictureSize);
        /// <summary>
