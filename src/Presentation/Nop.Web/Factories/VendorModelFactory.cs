...
namespace Nop.Web.Factories
{
    ...
    public partial class VendorModelFactory : IVendorModelFactory
    {
        ...
        public virtual ApplyVendorModel PrepareApplyVendorModel(ApplyVendorModel model,
            bool validateVendor, bool excludeProperties)
        {
            if (model == null)
        ...
        public virtual VendorInfoModel PrepareVendorInfoModel(VendorInfoModel model, Vendor vendorModel,
            bool excludeProperties, string overriddenVendorAttributesXml = "")
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));

            var vendor = _workContext.CurrentVendor ?? vendorModel;
