...
namespace Nop.Web.Factories
{
    public partial interface ICatalogModelFactory
    {
        ...
        HomeCategoryModel PrepareHomeCategoryModel();
        /// <summary>
        ...
        CategoryModel PrepareCategoryModel(Category category, CatalogPagingFilteringModel command, List<int> categoryParams = null);
        ...
        /// <returns></returns>
        CategoryNavigationModel PrepareFilteredCategoryNavigationModel(int filteredCategoryId, int categoryLevel);
        ...
        /// <param name="filteredCategoryId"></param>
        /// <param name="startCategoryLevel"></param>
        /// <param name="currentLevel"></param>
        /// <returns></returns>
        List<CategorySimpleModel> GetFilteredSubCategory(
            List<CategorySimpleModel> categories,
            int filteredCategoryId,
            int startCategoryLevel,
            int currentLevel = 1);
