...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<DisputeModelFactory>().As<IDisputeModelFactory>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<VendorApplicationModelFactory>().As<IVendorApplicationModelFactory>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<JobServiceCategoryModelFactory>().As<JobServiceCategoryModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<YadiyadNewsModelFactory>().As<YadiyadNewsModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ExpertiseModelFactory>().As<ExpertiseModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ProOrderModelFactory>().As<ProOrderModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ProOrderService>().As<ProOrderService>().InstancePerLifetimeScope();
            builder.RegisterType<ChargeModelFactory>().As<ChargeModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<BankAccountModelFactory>().As<BankAccountModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<CancellationRequestModelFactory>().As<CancellationRequestModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<PayoutModelFactory>().As<PayoutModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<CampaignManagementModelFactory>().As<CampaignManagementModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ApproveDepositRequestModelFactory>().As<ApproveDepositRequestModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ShipmentCarrierResolver>().As<ShipmentCarrierResolver>().InstancePerLifetimeScope();
            builder.RegisterType<JntShipmentCarrier>().As<IShippingCarrier>().InstancePerLifetimeScope();
            builder.RegisterType<LalamoveShipmentCarrier>().As<IShippingCarrier>().InstancePerLifetimeScope();
            builder.RegisterType<ShippingMethodService>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<AdminDashboardService>().As<IAdminDashboardService>().InstancePerLifetimeScope();
            builder.RegisterType<VendorDashboardService>().As<IVendorDashboardService>().InstancePerLifetimeScope();
            builder.RegisterType<AdminDashboardModelFactory>().As<IAdminDashboardModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ContactsModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<YadiyadReportingContactsService>().As<IYadiyadReportingContactsService>().InstancePerLifetimeScope();
            builder.RegisterType<OrderRefundRequestService>().As<OrderRefundRequestService>().InstancePerLifetimeScope();
            builder.RegisterType<OperationModelFactory>().InstancePerLifetimeScope();
