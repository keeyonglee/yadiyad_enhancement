        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            if (DataSettingsManager.DatabaseIsInstalled)
            {
                ...
                if (localizationSettings.SeoFriendlyUrlsForLanguagesEnabled)
                {
                    ...
                    rootPattern = "{language:lang=" + languages.FirstOrDefault().UniqueSeoCode + "}/";
                }
            }

            pattern = rootPattern + "shuq/";
            ...
            //about page
            endpointRouteBuilder.MapControllerRoute("About", $"{pattern}about/",
            ...
            //return
            //endpointRouteBuilder.MapControllerRoute("CancellationRefund", $"{pattern}cancellation-and-refund-policy-shuq",
            //    new { controller = "", action = "" });

            //dispute settlement
            //endpointRouteBuilder.MapControllerRoute("DisputeSettlement", $"{pattern}dispute-settlement-policy-shuq",
            //    new { controller = "", action = "" });

            //useragreement
            //endpointRouteBuilder.MapControllerRoute("UserAgreement", $"{pattern}user-agreement-shuq",
            //    new { controller = "", action = "" });

            //privacy policy
            //endpointRouteBuilder.MapControllerRoute("PrivacyPolicy", $"{pattern}privacy-policy-shuq",
            //    new { controller = "", action = "" });
            ...
            endpointRouteBuilder.MapControllerRoute("CustomerBankAccount", $"{pattern}customer/bankaccount",
                new { controller = "Customer", action = "BankAccount" });
            ...
            //faq
            endpointRouteBuilder.MapControllerRoute("Faq", $"{pattern}faq",
            ...
            //mart product search
            endpointRouteBuilder.MapControllerRoute("MartProductSearch", $"{pattern}mart/",
                new { controller = "Catalog", action = "SearchMartProduct" });

            //mart product search
            endpointRouteBuilder.MapControllerRoute("EatProductSearch", $"{pattern}eats/",
                new { controller = "Catalog", action = "SearchEatsProduct" });
            ...
            //reviews
            endpointRouteBuilder.MapControllerRoute("ShuqBuyerReview", pattern + "shuqbuyerreview/{orderItemId}",
                new { controller = "Product", action = "ShuqBuyerReview" });
            ...
            endpointRouteBuilder.MapControllerRoute("ProductReviewsPaged", pattern + "productreviews/{productId}/page/{pageNumber:min(0)}",
                new { controller = "Product", action = "ProductReviews" });
            ...
            endpointRouteBuilder.MapControllerRoute("ReturnRequestDetail",
                pattern + "returnRequestDetail/{orderId:min(0)}",
                new { controller = "ReturnRequest", action = "ReturnRequestDetail" });
            ...
            endpointRouteBuilder.MapControllerRoute("ReturnRequest_Customer",
                pattern + "returnrequest_customer/{orderId:min(0)}",
                new { controller = "ReturnRequest", action = "ReturnRequest_Customer" });
            ...
            endpointRouteBuilder.MapControllerRoute("OrderReceived",
                pattern + "OrderReceived",
                new { controller = "Order", action = "OrderReceived" });

            endpointRouteBuilder.MapControllerRoute("GetOrderPdfInvoice",
                pattern + "orderdetails/pdf/{orderId}",
                new { controller = "Order", action = "GetPdfInvoice" });

            endpointRouteBuilder.MapControllerRoute("GetConsignmentNotes",
                pattern + "orderdetails/awb/{shipmentId}",
                new { controller = "Order", action = "DownloadAWB" });

            endpointRouteBuilder.MapControllerRoute("AddReturnShipment",
                pattern + "orderdetails/ship/{orderId}",
                new { controller = "Order", action = "AddReturnShipment" });
            ...
            endpointRouteBuilder.MapControllerRoute("OrderCancellation",
                pattern + "orderCancellation/{orderId:min(0)}",
                new { controller = "Order", action = "OrderCancellation" });
            ...
            endpointRouteBuilder.MapControllerRoute("GetCitiesByStateId", $"{pattern}country/getcitiesbystateid/",
            ...
            endpointRouteBuilder.MapControllerRoute("GetOrderRefundRequestPdf",
                pattern + "returnrequest/pdf/{OrderRefundRequestId}",
                new { controller = "ReturnRequest", action = "Pdf" });
            ...
            //robots.txt
            endpointRouteBuilder.MapControllerRoute("robots.txt", $"{rootPattern}robots.txt",
                new { controller = "Common", action = "RobotsTextFile" });

            //sitemap (XML)
            endpointRouteBuilder.MapControllerRoute("sitemap.xml", $"{rootPattern}sitemap.xml",
                new { controller = "Common", action = "SitemapXml" });

            endpointRouteBuilder.MapControllerRoute("sitemap-indexed.xml",
                rootPattern + "sitemap-{Id:min(0)}.xml",
                new { controller = "Common", action = "SitemapXml" });
