...
namespace Nop.Web.Infrastructure.Cache
{
    public static partial class NopModelCacheDefaults
    {
        ...
        /// <summary>
        /// Key for vendor all product reviews caching
        /// </summary>
        /// <remarks>
        /// {0} : vendor id
        /// {1} : current store ID
        /// </remarks>
        public static CacheKey VendorAllProductReviewsModelKey => new CacheKey("Nop.pres.vendor.product.reviews-{0}-{1}", ProductReviewsPrefixCacheKey, ProductReviewsPrefixCacheKeyById);
        public static string VendorAllProductReviewsPrefixCacheKey => "Nop.pres.vendor.product.reviews";
        public static string VendorAllProductReviewsPrefixCacheKeyById => "Nop.pres.vendor.product.reviews-{0}-";
        ...
        /// {1} : current store ID
        /// </remarks>
        public static CacheKey HomepageBlogModelKey => new CacheKey("Nop.pres.blog.homepage-{0}-{1}", HomepageBlogPrefixCacheKey);
        public static string HomepageBlogPrefixCacheKey => "Nop.pres.blog";
