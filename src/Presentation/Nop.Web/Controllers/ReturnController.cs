...
namespace Nop.Web.Controllers
{
    ...
    public partial class ReturnController : BasePublicController
    {
        #region Fields
        ...
        public ReturnController(ICustomerService customerService,
        ...
        [HttpPost("create")]
        public IActionResult ReturnRequestSubmit([FromBody] SubmitReturnModel model)
        {
            ...
            var orderShipment = _shipmentService.GetShipmentsByOrderId(model.OrderId);
            ...
            {
                orderItems[i].Quantity = model.Items[i].Quantity;
            }
            ...
            if (model.ReturnRequestImageId != null)
            {
                for (int i = 0; i < model.ReturnRequestImageId.Count; i++)
                {
                    _returnRequestService.InsertReturnRequestImage(new ReturnRequestImage
                    {
                        GroupReturnRequestId = groupReturn.Id,
                        PictureId = model.ReturnRequestImageId[i],
                        DisplayOrder = 2,
                    });
                }
            }
