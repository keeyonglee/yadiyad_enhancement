            ...
            "ajax": {
                ...
                "dataFilter": function dataFilter(data) {
                    ...
                    dataList.forEach(function (item) {
                        ...
                        item.action = '<input class="btn btn-primary w-auto" value="Edit" type="button"' + 'data-toggle="modal" data-target="#modal-payout-request"   ' + 'data-keyboard="false" data-backdrop="static"              ' + 'href="' + urlgetPayoutRequest + '" />                      ';

                        if (item.status === 2) {
                            var urlGetPayoutInvoiceStatement = url.getPayoutInvoiceStatement.replace(/{{id}}/g, item.invoiceId);
                            item.action += '<a class="text-primary table-action d-inline-block" target="_blank"' + 'href="' + urlGetPayoutInvoiceStatement + '">[Invoice]</a>                      ';
                        }
                    ...
                    dataList.forEach(function (item) {
                        ...
                        if (item.status === 1) {
                            ...
                            if (item.serviceChargeInvoiceId) {
                                ...
                                item.action += '<a class="text-primary table-action" target="_blank"' + 'href="' + urlGetInvoiceStatement + '"><i class="fas fa-file-alt"></i>Invoice</a>';
                            }
                        } else {
