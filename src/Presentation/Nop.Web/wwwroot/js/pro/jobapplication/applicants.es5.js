...
var PageJobApplicant = function PageJobApplicant(opts) {
    var base = this;
    var url = opts.url;
    var msg = opts.msg;
    ...
    var model = {
        ...
        setJobEngagements: function setJobEngagements(result) {
            pagination.set(result);

            $.each(result.data, function (i, data) {
                if (data.serviceIndividualProfile && data.serviceIndividualProfile.dateOfBirth) {
                    data.serviceIndividualProfile.dateOfBirthText = moment(data.serviceIndividualProfile.dateOfBirth, 'YYYY-MM-DDTHH:mm:ss').format('DD MMM YYYY');
                }
        ...
        setSelectedJobEngagementStatus: function setSelectedJobEngagementStatus(status) {
        ...
        setSelectedJobEngagement: function setSelectedJobEngagement(jobEngagement) {
        ...
        updateSelectedJobEngagementStatus: function updateSelectedJobEngagementStatus(statusName, status) {
            ...
            "ajax": {
                ...
                "dataFilter": function dataFilter(data) {
                    ...
                    dataList.forEach(function (item) {
                        ...
                        item.action = '<input class="btn btn-primary w-auto" value="View" type="button"' + 'data-toggle="modal" data-target="#modal-payout-request"   ' + 'data-keyboard="false" data-backdrop="static"              ' + 'href="' + urlgetPayoutRequest + '" />                      ';
                ...
                "dataFilter": function dataFilter(data) {
                    ...
                    dataList.forEach(function (item) {
                        ...
                        if (item.status === 1) {
                            ...
                            item.action = '<a class="text-primary table-action" target="_blank"' + 'href="' + urlGetDepositRequestStatement + '"><i class="fas fa-file-alt"></i></a>                      ';
