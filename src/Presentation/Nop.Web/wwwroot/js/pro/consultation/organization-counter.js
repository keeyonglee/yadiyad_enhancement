var ComponentConsultationJobOrgCounter = function (containerSelector, opts) {
    var base = this;
    var url = opts.url;
...
var componentConsultationJobOrgCounter = new ComponentConsultationJobOrgCounter(
    '.content-consultation-job-org-counter',
    {
        'url': {
