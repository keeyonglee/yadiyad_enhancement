...
var ComponentSeekerCounter = function ComponentSeekerCounter(containerSelector, opts) {
    var base = this;
    var url = opts.url;
...
var componentSeekerCounter = new ComponentSeekerCounter('.content-job-seeker-counter', {
    'url': {
