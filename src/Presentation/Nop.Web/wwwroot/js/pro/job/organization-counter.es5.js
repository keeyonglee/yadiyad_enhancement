...
var ComponentOrganizationJobCounter = function ComponentOrganizationJobCounter(containerSelector, opts) {
    var base = this;
    var url = opts.url;
    ...
    base.setJobProfileInfo = function (response) {
        base.handleResponse(response, function (response) {
            ...
            if (response.data.viewJobCandidateFullProfileSubscriptionEndDate) {
                response.data.viewJobCandidateFullProfileSubscriptionEndDateText = moment(response.data.viewJobCandidateFullProfileSubscriptionEndDate, 'YYYY-MM-DD').add(timezone, 'hour').format('DD MMM YYYY');
            }
...
var componentOrganizationJobCounter = new ComponentOrganizationJobCounter('.content-organization-job-counter', {
    'url': {
