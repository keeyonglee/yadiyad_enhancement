...
var PageJobSeekerProfileDetails = function (selector, opts) {
    ...
    var model = {
        ...
        onIsFreelanceHourlyChanged: function () {
        ...
        onIsFreelanceDailyChanged: function () {
        ...
        onEmploymentStatusChanged: function (employmentStatus) {
        ...
        setData: function (data) {
            ...
            if (!data.id) {
                ...
                data.licenseCertificates
                    = data.licenseCertificates && data.licenseCertificates.length > 0
                        ? data.licenseCertificates
                        : [];
