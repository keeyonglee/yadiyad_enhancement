...
var PageJobSeekerProfileDetails = function PageJobSeekerProfileDetails(selector, opts) {
    ...
    var model = {
        ...
        updateJobModels: function updateJobModels() {
            var jobModels = [];
        ...
        updateJobTypes: function updateJobTypes() {
            var jobTypes = [];
        ...
        updateTenureDate: function updateTenureDate() {
            var tenureStartDate = "";
            var tenureEndDate = "";
        ...
        setData: function setData(data) {
            ...
            data.academicQualifications = data.academicQualifications || [{
                uid: app.randomId
            }];
            data.licenseCertificates = data.licenseCertificates || [];
