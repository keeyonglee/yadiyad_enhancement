...
var ComponentServiceSellerCounter = function ComponentServiceSellerCounter(containerSelector, opts) {
    var base = this;
    var url = opts.url;
...
var componentServiceSellerCounter = new ComponentServiceSellerCounter('.content-service-seller-counter', {
    'url': {
