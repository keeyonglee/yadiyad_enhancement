...
var ComponentServiceBuyerCounter = function ComponentServiceBuyerCounter(containerSelector, opts) {
    var base = this;
    var url = opts.url;
...
var componentServiceBuyerCounter = new ComponentServiceBuyerCounter('.content-service-buyer-counter', {
    'url': {
