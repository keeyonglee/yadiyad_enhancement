var PageDeclineJob = function (selector, pageJobInvites, opts) {
    var base = this;
    var url = opts.url;
...
var pageDeclineJob = new PageDeclineJob(
    '.content-decline-job-invite',
    pageJobInvites,
    {
        'url': {
