...
var SessionHandler = function (settings) {
    //setting
    var defaultConfig = {
    ...
    var setSessionExpiryDateTime = function (exp) {
        sessionExpiryDateTime = new Date(0);
        sessionExpiryDateTime.setUTCSeconds(exp);
        monitorSession();
    };

    var retrieveSessionExpiryDateTime = function (callback) {
        var settings = {
    ...
    var getSessionLeftTime = function () {
        return (sessionExpiryDateTime.getTime() - new Date().getTime()) / 1000;
    };

    var getIdleTimeoutTime = function () {
