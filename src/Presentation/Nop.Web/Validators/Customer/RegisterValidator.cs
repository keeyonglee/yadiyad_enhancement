...
namespace Nop.Web.Validators.Customer
{
    public partial class RegisterValidator : BaseNopValidator<RegisterModel>
    {
            ...
            CustomerSettings customerSettings)
        {
            ...
            if (customerSettings.StateProvinceRequired && customerSettings.StateProvinceEnabled)
            {
                RuleFor(x => x.StateProvinceId).NotEmpty().WithMessage(localizationService.GetResource("Address.Fields.State.Required"));
            }
