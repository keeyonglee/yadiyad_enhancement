...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
        ...
        protected virtual string ValidateCustomerRoles(IList<CustomerRole> customerRoles, IList<CustomerRole> existingCustomerRoles)
        {
            ...
            var isInGuestsRole = customerRoles.FirstOrDefault(cr => cr.SystemName == NopCustomerDefaults.GuestRoleName) != null;
        ...
        {
            var customers = _customerService.GetAllCustomers(customerRoleIds: new[] { _customerService.GetCustomerRoleBySystemName(NopCustomerDefaults.AdministratorRoleName).Id });
        ...
        public virtual IActionResult Create(CustomerModel model, bool continueEditing, IFormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (var customerRole in newCustomerRoles)
                {
                    ...
                    if (customerRole.SystemName == NopCustomerDefaults.AdministratorRoleName && !_customerService.IsAdmin(_workContext.CurrentCustomer))
                        continue;
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    foreach (var customerRole in allCustomerRoles)
                    {
                        ...
                        if (customerRole.SystemName == NopCustomerDefaults.AdministratorRoleName &&
                        ...
                        else
                        {
                            ...
                            if (customerRole.SystemName == NopCustomerDefaults.AdministratorRoleName && !SecondAdminAccountExists(customer))
                            {
