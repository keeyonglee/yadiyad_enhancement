...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IProductModelFactory
    {
        ...
        ProductModel PrepareProductModel(ProductModel model, Product product, bool excludeProperties = false, int allowedCategoryId = 0);
        ...
        /// <returns></returns>
        bool CheckAllowOrderSetting(Vendor vendor);
    }
}