...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class VendorModelFactory : IVendorModelFactory
    {
        ...
        protected virtual void PrepareAddressModel(AddressModel model, Address address)
        {
            ...
            model.CountryEnabled = model.CountryRequired = true;
            model.StateProvinceEnabled = true;
            model.CountyEnabled = false;
            model.CityEnabled = model.CityRequired = true;
            model.StreetAddressEnabled = model.StreetAddressRequired = true;
            model.StreetAddress2Enabled = true;
            model.ZipPostalCodeEnabled = model.ZipPostalCodeRequired = true;
            model.PhoneEnabled = model.PhoneRequired = true;
            model.FaxEnabled = true;
            model.GeolocationEnabled = model.GeolocationRequired = true;
        ...
        /// <summary>
        /// Prepare vendor picture search model
        /// </summary>
        /// <param name="searchModel">Vendor picture search model</param>
        /// <param name="vendor">Vendor</param>
        /// <returns>Vendor pciture search model</returns>
        ...
        public virtual VendorModel PrepareVendorModel(VendorModel model, Vendor vendor, bool excludeProperties = false)
        {
            ...
            if (vendor != null)
            {
                ...
                if (model == null)
                {
                    ...
                    model.Online = _vendorService.GetVendorOnlineStatus(vendor);
                }
                ...
                model.AvailableVendorPictureTypes = Enum.GetValues(typeof(VendorPictureType))
                        .Cast<VendorPictureType>()
        ...
        public virtual VendorPictureListModel PrepareVendorPictureListModel(VendorPictureSearchModel searchModel, Vendor vendor)
        {
            ...
            //get vendor pictures
            var vendorPictures = _vendorService.GetVendorPicturesByVendorId(vendor.Id).ToPagedList(searchModel);

            //prepare grid model
            var model = new VendorPictureListModel().PrepareToGrid(searchModel, vendorPictures, () =>
            {
                return vendorPictures.Select(vendorPicture =>
                {
                    //fill in model values from the entity
                    ...
                    vendorPictureModel.PictureUrl = _pictureService.GetPictureUrl(ref picture);
