...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
        ...
        public virtual ProductSearchModel PrepareProductSearchModel(ProductSearchModel searchModel)
        {
            ...
            _baseAdminModelFactory.PrepareProductApprovalStatus(searchModel.AvailableProductApprovalStatus);
        ...
        public virtual ProductListModel PrepareProductListModel(ProductSearchModel searchModel)
        {
            ...
            var products = _productService.SearchProducts(showHidden: true,
                ...
                productApprovalStatus: searchModel.SearchProductApprovalStatusId > 0 ? (ProductApprovalStatus?)searchModel.SearchProductApprovalStatusId : null);
            ...
            var model = new ProductListModel().PrepareToGrid(searchModel, products, () =>
            {
                return products.Select(product =>
                {
                    ...
                    productModel.ProductApprovalStatusName = _localizationService.GetLocalizedEnum(product.ProductApprovalStatus);
        ...
        public virtual ProductModel PrepareProductModel(ProductModel model, Product product, bool excludeProperties = false, int allowedCategoryId = 0)
        {
            ...
            model.IsShipMandatory = _shippingSettings.IsShipMandatory;
            model.IsShipEnabled = model.IsShipMandatory || model.IsShipEnabled;
            ...
            _baseAdminModelFactory.PrepareDeliveryModes(model.AvailableDeliveryModes,
                defaultItemText: _localizationService.GetResource("Admin.Catalog.Products.Fields.DeliveryMode.None"));
            ...
            if(allowedCategoryId == 0)
            {
                _baseAdminModelFactory.PrepareCategories(model.AvailableCategories, false);
            }
            else if (allowedCategoryId == _vendorSettings.ShuqEatsCategoryId)
            {
                _baseAdminModelFactory.PrepareEatCategories(model.AvailableCategories, false);
            }
            else if (allowedCategoryId == _vendorSettings.ShuqMartCategoryId)
            {
                _baseAdminModelFactory.PrepareMartCategories(model.AvailableCategories, false);
            }
            ...
            var availableDiscounts = _discountService.GetAllDiscounts(DiscountType.AssignedToProducts, showHidden: true);
        ...
        /// <summary>
        /// Check if allow order setting
        /// </summary>
        /// <param name="vendor"></param>
        /// <returns></returns>
        public bool CheckAllowOrderSetting(Vendor vendor)
        {
            var allowOrderSetting = false;

            allowOrderSetting = vendor.CategoryId == _vendorSettings.ShuqEatsCategoryId;

            return allowOrderSetting;
        }
