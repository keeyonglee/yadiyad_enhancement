...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IReturnRequestModelFactory
    {
        ...
        GroupReturnRequestListModel PrepareGroupReturnRequestListModel(ReturnRequestSearchModel searchModel);
        ReturnRequestListModel PrepareReturnRequestListModel(ReturnRequestItemSearchModel searchModel);
        ReturnOrderSearchModel PrepareReturnOrderSearchModel(ReturnOrderSearchModel searchModel);
        ReturnOrderModel PrepareReturnOrderModel(ReturnOrderModel model, int id, bool excludeProperties = false);
        ReturnOrderListModel PrepareReturnOrderListModel(ReturnOrderSearchModel searchModel);
        /// <summary>
        ...
        GroupReturnRequestModel PrepareReturnRequestModel(GroupReturnRequestModel model,
            ReturnRequest returnRequest, bool excludeProperties = false);

        SellerDisputeModel PrepareSellerDisputeModel(SellerDisputeModel model,
            ReturnRequest returnRequest, bool excludeProperties = false);
        DisputeSubmitModel PrepareDisputeSubmitModel(DisputeSubmitModel model,
            int id, bool excludeProperties = false);
        ReturnRequestModel PrepareSingleReturnRequestModel(ReturnRequestModel model,
            ReturnRequest returnRequest, bool excludeProperties = false);
        /// <summary>
