...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IOrderModelFactory
    {
        ...
        VendorOrderShipmentModelList PrepareVendorOrderShipmentModel(OrderSearchModel searchModel);
        VendorReturnRequestActionListModel PrepareVendorOrderReturnModel(OrderSearchModel searchModel);
        VendorProductSummaryListModel PrepareVendorTopSoldProductsModel(OrderSearchModel searchModel);
        VendorProductSummaryListModel PrepareVendorTopReturnedProductsModel(OrderSearchModel searchModel);
    }
}