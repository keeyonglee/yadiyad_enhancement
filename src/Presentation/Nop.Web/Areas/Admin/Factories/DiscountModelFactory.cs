...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class DiscountModelFactory : IDiscountModelFactory
    {
        ...
        public virtual DiscountSearchModel PrepareDiscountSearchModel(DiscountSearchModel searchModel)
        {
            ...
            {
                var vendorId = _workContext.CurrentCustomer.VendorId;
                ...
                searchModel.SearchVendorId = vendorId;
                searchModel.AvailableVendors.Add(selectedItem);
            }
        ...
        public virtual DiscountListModel PrepareDiscountListModel(DiscountSearchModel searchModel)
        {
            ...
            var model = new DiscountListModel().PrepareToGrid(searchModel, discounts, () =>
            {
                return discounts.Select(discount =>
                {
                    ...
                    if(discountModel.VendorId.HasValue)
                    {
                        discountModel.VendorName = _vendorService.GetVendorById(discountModel.VendorId.Value).Name;
                    }
        ...
        public virtual DiscountModel PrepareDiscountModel(DiscountModel model, Discount discount, bool excludeProperties = false)
        {
            ...
            if (discount != null)
            {
                ...
                model.IsAdmin = _customerService.IsAdmin(customer);

                if (model.IsAdmin)
                {
                    _baseAdminModelFactory.PrepareVendors(model.AvailableVendors, false);
                }
                else
                {
                    var vendorId = _workContext.CurrentCustomer.VendorId;
                    ...
                    model.AvailableVendors.Add(selectedItem);
                }
        ...
        public virtual AddProductToDiscountSearchModel PrepareAddProductToDiscountSearchModel(AddProductToDiscountSearchModel searchModel, int vendorId)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
