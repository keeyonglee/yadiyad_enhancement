...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        protected virtual SecuritySettingsModel PrepareSecuritySettingsModel()
        {
            ...
            model.DataProtectedEncryptionKey = securitySettings.DataProtectedEncryptionKey;

            if (string.IsNullOrWhiteSpace(model.DataProtectedEncryptionKey) == false)
            {
                try
                {
                    var protector = _dataProtector.CreateProtector("PersonalData");
                    model.DataProtectedEncryptionKey = protector.Unprotect(model.DataProtectedEncryptionKey);
                }
