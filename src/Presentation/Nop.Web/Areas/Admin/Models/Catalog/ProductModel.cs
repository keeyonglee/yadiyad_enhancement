...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
        ...
        IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
    {
        ...
        public ProductModel()
        {
            ...
            AvailableDeliveryModes = new List<SelectListItem>();
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProductApprovalStatus")]
        public int? ProductApprovalStatusId { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProductApprovalStatus")]
        public string ProductApprovalStatusName { get; set; }
        ...
        public bool IsShipMandatory { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.DeliveryMode")]
        public int? DeliveryModeId { get; set; }
        public IList<SelectListItem> AvailableDeliveryModes { get; set; }
        ...
        #region Product Order Settings

        public bool AllowOrderSetting { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.AdvancedOrderDay")]
        public int? AdvancedOrderDay { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MonMaxNoOrderQty")]
        public int? MonMaxNoOrderQty { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.TueMaxNoOrderQty")]
        public int? TueMaxNoOrderQty { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.WedMaxNoOrderQty")]
        public int? WedMaxNoOrderQty { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ThuMaxNoOrderQty")]
        public int? ThuMaxNoOrderQty { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.FriMaxNoOrderQty")]
        public int? FriMaxNoOrderQty { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.SatMaxNoOrderQty")]
        public int? SatMaxNoOrderQty { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.SunMaxNoOrderQty")]
        public int? SunMaxNoOrderQty { get; set; }

        public int? VendorCategoryId { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.DeliveryDates")]
        public string DeliveryDatesStr { get; set; }
        ...
        public List<DateTime> DeliveryDates
        {
            get
            {
                ...
                if (string.IsNullOrWhiteSpace(DeliveryDatesStr) == false)
                {
                    try
                    {
                        var deliveryDatesStrList = DeliveryDatesStr.Split(',', StringSplitOptions.RemoveEmptyEntries).ToList();

                        foreach(var strDate in deliveryDatesStrList)
                        {
                            deliveryDates.Add(DateTime.ParseExact(strDate, "yyyy-MM-dd", CultureInfo.InvariantCulture));
                        }
                    }
                    catch (Exception ex)
                    {
            ...
            set
            {
                ...
                {
                    DeliveryDatesStr = null;
                }
                else
                {
                    DeliveryDatesStr = string.Join(',', value.Select(x=>x.ToString("yyyy-MM-dd")).ToList());
                }
            }
        }
