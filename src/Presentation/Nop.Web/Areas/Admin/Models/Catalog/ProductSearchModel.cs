...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
    ...
    public partial class ProductSearchModel : BaseSearchModel
    {
        ...
        public ProductSearchModel()
        {
            ...
            AvailableProductApprovalStatus = new List<SelectListItem>();
        }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.List.ProductApprovalStatus")]
        public int SearchProductApprovalStatusId { get; set; }
        ...
        public bool AllowVendorsToExportProducts { get; set; }
        ...
        public IList<SelectListItem> AvailableProductApprovalStatus { get; set; }
