...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateCatalogMaps()
        {
            ...
            CreateMap<ChargeModel, Charge>();

            CreateMap<ConsultationInvitation, CancellationRequestModel>();
            CreateMap<CancellationRequestModel, ConsultationInvitation>();

            CreateMap<CampaignManagement, CampaignManagementModel>();
            CreateMap<CampaignManagementModel, CampaignManagement>();

            CreateMap<DepositRequest, ApproveDepositRequestModel>();
            CreateMap<ApproveDepositRequestModel, DepositRequest>();
        ...
        protected virtual void CreateNewsMaps()
        {
            ...
            CreateMap<NewsItem, YadiyadNewsModel>();
            CreateMap<YadiyadNewsModel, NewsItem>();
        ...
        protected virtual void CreateVendorApplicationsMaps()
        {
            CreateMap<VendorApplication, VendorApplicationModel>();
            CreateMap<VendorApplicationModel, VendorApplication>()
                .ForMember(entity => entity.Deleted, options => options.Ignore());
        }
        /// <summary>
