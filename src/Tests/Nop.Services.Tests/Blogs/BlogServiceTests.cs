...
namespace Nop.Services.Tests.Blogs
{
    ...
    public class BlogServiceTests
    {
        ...
        public void SetUp()
        {
            _blogService = new BlogService(new CatalogSettings(), new FakeCacheKeyService(),  null, null, null, null, new TestCacheManager(), new Mock<IRepository<BlogPostPictureMapping>>().Object);
        }
