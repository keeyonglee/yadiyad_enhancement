...
namespace Nop.Services.Tests.Catalog
{
    ...
    public class PriceCalculationServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            _productService = new ProductService(new CatalogSettings(), new CommonSettings(), null, new FakeCacheKeyService(), _icategoryService, _customerService,
                null, null, null, null, null, null, null, null, null, null, null,_discountProductMappingRepository.Object,
                ...
                null, null, null, null, new LocalizationSettings(), new Mock<IRepository<ProductReviewPictureMapping>>().Object, null, null);
        ...
        private readonly Discount _mockDiscount = new Discount
        {
            Id = 1,
            Name = "Discount 1",
            DiscountType = DiscountType.AssignedToProducts,
            DiscountAmount = 3,
