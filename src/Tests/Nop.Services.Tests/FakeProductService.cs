...
namespace Nop.Services.Tests
{
    public class FakeProductService : ProductService
    {
        public FakeProductService(CatalogSettings catalogSettings = null,
            ...
            IRepository<Vendor> vendorRepository = null,
            ...
            VendorSettings vendorSettings = null) : base(
                ...
                categoryRepository.FakeRepoNullPropagation(),
                vendorRepository.FakeRepoNullPropagation(),
                ...
                null, vendorSettings ?? new VendorSettings(), null)
        {
        }
    }
}
