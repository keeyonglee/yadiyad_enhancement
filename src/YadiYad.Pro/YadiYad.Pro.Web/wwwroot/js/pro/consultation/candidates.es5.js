...
var PageConsultationCandidates = function PageConsultationCandidates(opts) {
    var base = this;
    ...
    var model = opts.model || {
        ...
        searchCandidates: function searchCandidates() {
        ...
        setCandidateSelected: function setCandidateSelected(candidatesSelected) {
            $.observable(this.candidateResult).setProperty("selected", candidatesSelected);
            return false;
        },
        inviteCandidates: function inviteCandidates(selectedCandidate) {
        ...
        setCandidatePastJob: function setCandidatePastJob(candidatesSelected, pastJobs) {
            var selectedCandidates = $.grep(this.candidateResult.data, function (item) {
        ...
        showMoreCandidateDetail: function showMoreCandidateDetail(ev, eventArgs) {
    ...
    var init = function init() {
        ...
        $.observable(model).observeAll(function () {
            var candidatesSelected = model.candidateResult.data.filter(function (item) {
                return item.selected;
            }).length !== 0;
