var PageConfirmedConsultationOrder = function (opts) {
    var base = this;
    ...
    var model = opts.model || {
        ...
        publishReview: function () {
            ...
            base.reviewConsultationInvitation(
                this.selectedConsultationInvitation.id,
                data,
                base.reviewConsultationInvitationResponse);

            return false;
        },
        selectApplicant: function (applicant) {
        ...
        stopSelectApplicantRefund : function () {
