...
var PageReviewJob = function PageReviewJob(selector, pageJobApplicant, opts) {
    var base = this;
    var url = opts.url;
    ...
    var model = opts.model || {
        ...
        publishReview: function publishReview() {
            ...
            base.reviewJobApplicant(this.id, data, base.reviewJobApplicantResponse);
...
var pageReviewJob = new PageReviewJob('.content-review-job', pageJobApplicant, {
    'url': {
