...
var PageJobInvites = function PageJobInvites(opts) {
    ...
    var model = opts.model || {
        ...
        selectedJobInvite: [],
        setJobInvitesResult: function setJobInvitesResult(result) {
                ...
                if (item.consultationProfile) {
                    ...
                    item.consultationProfile.timeSlots.forEach(function (timeSlot, i) {
                        ...
                        timeSlot.selected = item.consultantAvailableTimeSlots.filter(function (selectedTimeSlot) {
                            return selectedTimeSlot.startDate === timeSlot.startDate && selectedTimeSlot.endDate === timeSlot.endDate;
                        }).length > 0;
                    });
        ...
        setSelectedJobInvite: function setSelectedJobInvite(jobInvite) {
            var vm = this;
        ...
        replyJobInvite: function replyJobInvite(action, jobInvite) {
            ...
            } else if (this.selectedJobInvite.consultationProfile && this.selectedJobInvite.showQuestionnaire !== true) {
        ...
        selectConsultationTimeSlot: function selectConsultationTimeSlot(timeSlot) {
