...
{
    public partial class RegisterProModel : BaseNopModel
    {
        public RegisterProModel()
        {
            AvailableTimeZones = new List<SelectListItem>();
            AvailableCountries = new List<SelectListItem>();
            AvailableStates = new List<SelectListItem>();
            CustomerAttributes = new List<CustomerAttributeProModel>();
            GdprConsents = new List<GdprConsentProModel>();
        }
        ...
        public IList<GdprConsentProModel> GdprConsents { get; set; }
    }
}