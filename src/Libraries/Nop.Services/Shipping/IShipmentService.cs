...
namespace Nop.Services.Shipping
{
    ...
    public partial interface IShipmentService
    {
        ...
        IList<Shipment> GetReturnShipmentsByOrderId(int orderId, bool? shipped = null, int vendorId = 0);
        /// <summary>
        /// Gets a shipment
        /// </summary>
        ...
        IList<Shipment> GetShipmentsByReturnOrderId(int returnOrderId, bool? shipped = null, int vendorId = 0);
        /// <summary>
        /// Inserts a shipment
        /// </summary>
        /// <param name="shipment">Shipment</param>
        ...
        IList<Shipment> GetPendingReturnShipments(DateTime cutOffDate);

        string CreateLalamoveScheduleAt(string deliveryDate, string deliveryTime);
        DateTime? GetDeliverySlot(string deliveryDateText, string deliveryTimeText);
        Shipment GetShipmentByTrackingNumber(int trackingNumber);
    }
}