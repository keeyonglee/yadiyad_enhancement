    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public virtual Customer GetOrCreateBackgroundTaskUser()
        {
            ...
            if(backgroundTaskUser is null)
            {
                ...
                var guestRole = GetCustomerRoleBySystemName(NopCustomerDefaults.GuestRoleName);
        ...
        public virtual void DeactivateCustomer(Customer customer)
        {
            if (customer == null)
        ...
        {
            return IsInCustomerRole(customer, NopCustomerDefaults.AdministratorRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomerDefaults.ModeratorRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomerDefaults.GuestRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomerDefaults.VendorRoleName, onlyActiveCustomerRoles);
        }
