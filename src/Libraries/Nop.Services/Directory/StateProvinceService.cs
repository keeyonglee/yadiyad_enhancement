...
namespace Nop.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        //custom
        public virtual IPagedList<StateProvince> GetStateProvincesByCountryIdWithPaging(
            int countryId = 0, 
            int pageIndex = 0, 
            ...
            string keyword = null)
        {
            ...
            if (countryId != 0)
            {
                query = query.Where(n => n.CountryId == countryId);
            }
            ...
            var news = new PagedList<StateProvince>(query, pageIndex, pageSize);
