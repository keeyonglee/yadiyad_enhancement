...
namespace Nop.Services.ExportImport
{
    ...
    public partial interface IExportManager
    {
        ...
        byte[] ExportOrganizationToXlsx(IList<ReportingContactsOrganizationDTO> contacts);
        byte[] ExportRegistrationOnlyToXlsx(IList<ReportingContactsOrganizationDTO> contacts);
        byte[] ExportRegistrationProfileToXlsx(IList<ReportingContactsOrganizationDTO> contacts);
        byte[] ExportIndividualServiceJobToXlsx(IList<ReportingContactsOrganizationDTO> items);
        byte[] ExportProRevenueToXlsx(IList<ReportingProRevenueListDTO> items);
        byte[] ExportProExpensesToXlsx(IList<ReportingProRevenueListDTO> items);
        byte[] ExportShuqRevenueToXlsx(IList<ReportingProRevenueListDTO> items);
