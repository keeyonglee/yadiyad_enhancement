...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPlacedCustomerNotification(Order order, Customer customer, int languageId, 
            string attachmentFilePath = null, string attachmentFileName = null);
        ...
        IList<int> SendOrderCompletedVendorNotification(Order order, Vendor vendor, int languageId);
        IList<int> SendOrderCancelledVendorNotification(Order order, Vendor vendor, int languageId);
        IList<int> SendOrderReturnRefundVendorNotification(Order order, Vendor vendor, int languageId);
        IList<int> SendOrderPreparingCustomerNotification(Order order, Customer customer, int languageId);
        ...
        IList<int> SendOrderReturnApproveCustomerNotification(Order order);
        IList<int> SendOrderRefundApproveCustomerNotification(Order order);

        IList<int> SendOrderDisputeOutcomeFullRefundAndReturnCustomerNotification(Order order, Dispute dispute);
        IList<int> SendOrderDisputeOutcomePartialRefundAndReturnCustomerNotification(Order order, Dispute dispute);
        IList<int> SendOrderDisputeOutcomeRejectedCustomerNotification(Order order, Dispute dispute);
        IList<int> SendOrderDisputeOutcomeFullRefundCustomerNotification(Order order, Dispute dispute);
        IList<int> SendOrderDisputeOutcomePartialRefundCustomerNotification(Order order, Dispute dispute);

        IList<int> SendOrderDisputeOutcomeFullRefundAndReturnVendorNotification(Order order, Vendor vendor, Dispute dispute);
        IList<int> SendOrderDisputeOutcomePartialRefundAndReturnVendorNotification(Order order, Vendor vendor, Dispute dispute);
        IList<int> SendOrderDisputeOutcomeRejectedVendorNotification(Order order, Vendor vendor, Dispute dispute);
        IList<int> SendOrderDisputeOutcomeFullRefundVendorNotification(Order order, Vendor vendor, Dispute dispute);
        IList<int> SendOrderDisputeOutcomePartialRefundVendorNotification(Order order, Vendor vendor, Dispute dispute);
        ...
        IList<int> SendNewVendorAccountApproveStoreOwnerNotification(Customer customer, Vendor vendor, int languageId);
        IList<int> SendNewVendorAccountRejectStoreOwnerNotification(Customer customer, Vendor vendor, string remark, int languageId);
        ...
        /// <summary>
        /// Sends a "product approval request" notification to a operator
        /// </summary>
        /// <param name="product">Product</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendProductPublishApprovalRequestOperatorNotification(Product product, int languageId);

        /// <summary>
        /// Sends a "product approved" notification to a store owner
        /// </summary>
        /// <param name="product">Product</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendProductPublishApprovedStoreOwnerNotification(Product product, Vendor vendor, int languageId);

        /// <summary>
        /// Sends a "product rejected" notification to a store owner
        /// </summary>
        /// <param name="product">Product</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendProductPublishRejecteddStoreOwnerNotification(Product product, Vendor vendor, int languageId);

        #endregion

        #region Bank
        IList<int> SendBankApprovalEmail(Customer customer, int languageId);
        IList<int> SendBankRejectedEmail(Customer customer, int languageId);
        #endregion

        #region Shipment

        IList<int> SendReminderArrangeDriverRequestNowVendorNotification(Order order, Vendor vendor, int languageId);
        IList<int> SendUnableToLocateDriverVendorNotification(Order order, Vendor vendor, int languageId);
