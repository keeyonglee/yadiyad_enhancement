...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddStoreTokens(IList<Token> tokens, Store store, EmailAccount emailAccount)
        {
            ...
            tokens.Add(new Token("Shuq.Url.SellerGuideline", _storeInformationSettings.ShuqSellerGuidelineLink));
            tokens.Add(new Token("Shuq.Url.SellerAppGuideline", _storeInformationSettings.ShuqSellerAppGuidelineLink));
            tokens.Add(new Token("Shuq.Url.ContactUs", _storeInformationSettings.ShuqContactUsLink));
        ...
        public virtual void AddProductTokens(IList<Token> tokens, Product product, int languageId)
        {
            ...
            tokens.Add(new Token("Product.ProductURLForOperator", productManageUrl, true));
        ...
        public void AddOrderPayoutRequest(List<Token> commonTokens, OrderPayoutRequest orderPayoutRequest, int languageId)
        {
            ...
            if (language != null && !string.IsNullOrEmpty(language.LanguageCulture))
            {
                ...
                commonTokens.Add(new Token("OrderPayoutRequest.CreatedOn", createdOn.ToString("D", new CultureInfo(language.LanguageCulture))));
            }
            else
            {
                commonTokens.Add(new Token("OrderPayoutRequest.CreatedOn", orderPayoutRequest.CreatedOnUTC.ToString("D")));
            }

            commonTokens.Add(new Token("OrderPayoutRequest.OrderId", orderPayoutRequest.OrderId));
            commonTokens.Add(new Token("OrderPayoutRequest.Price​", orderTotalPrice));
        }
