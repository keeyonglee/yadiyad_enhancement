...
namespace Nop.Services.Messages
{
    ...
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        public virtual IList<int> SendOrderPlacedCustomerNotification(Order order, Customer customer, int languageId,
            string attachmentFilePath = null, string attachmentFileName = null)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
        ...
        public virtual IList<int> SendOrderPreparingCustomerNotification(Order order, Customer customer, int languageId)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderPreparingCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <summary>
        /// Sends an order completed notification to a vendor
        /// </summary>
        /// <param name="order">Order instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual IList<int> SendOrderCompletedVendorNotification(Order order, Vendor vendor, int languageId)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderCompletedVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual IList<int> SendOrderCancelledVendorNotification(Order order, Vendor vendor, int languageId)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderCancelledVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <summary>
        /// Sends an order return / refund notification to a vendor
        /// </summary>
        /// <param name="order">Order instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public virtual IList<int> SendOrderReturnRefundVendorNotification(Order order, Vendor vendor, int languageId)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderReturnRefundVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderReturnApproveCustomerNotification(Order order)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderReturnApproveCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
            ...
            var commonTokens = new List<Token>();
            _messageTokenProvider.AddOrderTokens(commonTokens, order, languageId);
            _messageTokenProvider.AddOrderSettingsTokens(commonTokens);
        ...
        public virtual IList<int> SendOrderRefundApproveCustomerNotification(Order order)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderRefundApproveCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomeFullRefundAndReturnCustomerNotification(Order order, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomeFullRefundAndReturnCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
            ...
            var commonTokens = new List<Token>();
            _messageTokenProvider.AddOrderTokens(commonTokens, order, languageId);
            _messageTokenProvider.AddDisputeTokens(commonTokens, dispute);
            _messageTokenProvider.AddOrderSettingsTokens(commonTokens);
        ...
        public virtual IList<int> SendOrderDisputeOutcomePartialRefundAndReturnCustomerNotification(Order order, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomePartialRefundAndReturnCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomeRejectedCustomerNotification(Order order, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomeNoRefundCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomeFullRefundCustomerNotification(Order order, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomeFullRefundCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomePartialRefundCustomerNotification(Order order, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomePartialRefundCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomeFullRefundAndReturnVendorNotification(Order order, Vendor vendor, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomeFullRefundAndReturnVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomePartialRefundAndReturnVendorNotification(Order order, Vendor vendor, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomePartialRefundAndReturnVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomeRejectedVendorNotification(Order order, Vendor vendor, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomeNoRefundVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomeFullRefundVendorNotification(Order order, Vendor vendor, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomeFullRefundVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendOrderDisputeOutcomePartialRefundVendorNotification(Order order, Vendor vendor, Dispute dispute)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.OrderDisputeOutcomePartialRefundVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendNewVendorAccountApproveStoreOwnerNotification(Customer customer, Vendor vendor, int languageId)
        {
            if (customer == null)
                throw new ArgumentNullException(nameof(customer));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.NewVendorAccountApproveStoreOwnerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendNewVendorAccountRejectStoreOwnerNotification(Customer customer, Vendor vendor, string remark, int languageId)
        {
            if (customer == null)
                throw new ArgumentNullException(nameof(customer));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.NewVendorAccountRejectStoreOwnerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
            ...
            _messageTokenProvider.AddCustomerTokens(commonTokens, customer);
            _messageTokenProvider.AddVendorTokens(commonTokens, vendor);
            commonTokens.Add(new Token("VendorApplication.RejectRemark", remark));
        ...
        public virtual IList<int> SendQuantityBelowVendorNotification(Product product, Vendor vendor, int languageId)
        {
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.QuantityBelowVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendQuantityBelowVendorNotification(ProductAttributeCombination combination, Vendor vendor, int languageId)
        {
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.QuantityBelowAttributeCombinationVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <summary>
        /// Sends a "product publish approval request" notification to a operator
        /// </summary>
        /// <param name="product">Product</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendProductPublishApprovalRequestOperatorNotification(Product product, int languageId)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.ProductPublishApprovalRequestOperatorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
            ...
            var operatorRole = _customerService.GetCustomerRoleBySystemName(NopCustomerDefaults.OperatorRoleName);

            var operators = _customerService.GetAllCustomers(
                null,
                customerRoleIds: new int[] { operatorRole.Id});
            ...
            return messageTemplates.Select(messageTemplate =>
            {
                ...
                operators.ToList().ForEach(optr =>
                {
                    var toEmail = optr.Email;
                    var toName = default(string);

                    noEmail += SendNotification(messageTemplate, emailAccount, languageId, tokens, toEmail, toName);
                });
        ...
        /// <summary>
        /// Sends a "product publish approved" notification to a store owner
        /// </summary>
        /// <param name="product">Product</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendProductPublishApprovedStoreOwnerNotification(Product product, Vendor vendor, int languageId)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.ProductPublishApprovedStoreOwnerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <summary>
        /// Sends a "product publish rejected" notification to a store owner
        /// </summary>
        /// <param name="product">Product</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendProductPublishRejecteddStoreOwnerNotification(Product product, Vendor vendor, int languageId)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.ProductPublishRejectedStoreOwnerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        #region Bank
        public virtual IList<int> SendBankApprovalEmail (Customer customer, int languageId)
        {
            if (customer == null)
                throw new ArgumentNullException(nameof(customer));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.CustomerBankAccountApplicationApprovedMessage, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendBankRejectedEmail(Customer customer, int languageId)
        {
            if (customer == null)
                throw new ArgumentNullException(nameof(customer));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.CustomerBankAccountApplicationRejectedMessage, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendNewPayoutVendorNotification(OrderPayoutRequest orderPayoutRequest, Vendor vendor, int languageId)
        {
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.NewPayoutVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
            ...
            _messageTokenProvider.AddOrderTokens(commonTokens, order, languageId, vendor.Id);
            _messageTokenProvider.AddVendorTokens(commonTokens, vendor);
            _messageTokenProvider.AddOrderPayoutRequest(commonTokens, orderPayoutRequest, languageId);
        ...
        public virtual IList<int> SendReminderArrangeDriverRequestNowVendorNotification(Order order, Vendor vendor, int languageId)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.ReminderArrangeDriverRequestNowVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        public virtual IList<int> SendUnableToLocateDriverVendorNotification(Order order, Vendor vendor, int languageId)
        {
            if (order == null)
                throw new ArgumentNullException(nameof(order));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.UnableToLocateDriverVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
