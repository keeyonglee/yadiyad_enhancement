...
namespace Nop.Services.Orders
{
    ...
    public partial class CheckoutAttributeService : ICheckoutAttributeService
    {
        ...
        public CheckoutAttribute GetCheckoutAttributeByName(string checkoutAttributeName)
        {
            if (String.IsNullOrEmpty(checkoutAttributeName))
                return null;

            return _checkoutAttributeRepository.Table.FirstOrDefault(x => x.Name == checkoutAttributeName);
        }
        ...
        #region Checkout attributes Shuq

        public string GetCheckoutAttributeDeliveryTimeSlot(string attributesXml)
        {
            var attribute = GetCheckoutAttributeByName(NopOrderDefaults.DeliveryDate);
            //var timeSlotId =  _checkoutAttributeParser.ParseValues(attributesXml, attribute.Id).FirstOrDefault();
            return "test";
        }

        public string GetCheckoutAttributeDeliveryDate(string attributesXml)
        {
            var attribute = GetCheckoutAttributeByName(NopOrderDefaults.DeliveryDate);
            //return _checkoutAttributeParser.ParseValues(attributesXml, attribute.Id).FirstOrDefault();
            return "test";
        }
