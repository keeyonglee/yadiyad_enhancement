...
namespace Nop.Services.Orders
{
    ...
    public static partial class NopOrderDefaults
    {
        ...
        public const string DeliveryTimeSlot = "Delivery Time Slot";
        public const string CustomerShoppingCartCacheKey = "Nop.shoppingcart-{0}-";
        ...
        /// {4} : created from date
        /// {5} : created to date
        /// {6} : isOnlySelectedItems
        /// </remarks>
        public static CacheKey ShoppingCartCacheKey => new CacheKey(CustomerShoppingCartCacheKey + "{1}-{2}-{3}-{4}-{5}-{6}", ShoppingCartPrefixCacheKey);
