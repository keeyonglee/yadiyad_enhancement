...
namespace Nop.Services.Orders
{
    ...
    public partial class CheckoutAttributeParser : ICheckoutAttributeParser
    {
        ...
        public virtual IList<string> GetCheckoutAttributeValues(string attributeXml, string attributeName)
        {
            var attribute = _checkoutAttributeService.GetAllCheckoutAttributes()
                .FirstOrDefault(x => x.Name.Equals(attributeName, StringComparison.OrdinalIgnoreCase));

            if(attribute == null)
                return new List<string>();

            return ParseValues(attributeXml, attribute.Id);
        }
