...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        bool CheckIfNeedReturn(Order order);
        /// <summary>
        /// Places an order
        /// </summary>
        ...
        PlaceOrderResult PlaceOrderWithVendor(int vendorId, ProcessPaymentRequest processPaymentRequest, IEnumerable<int> itemIds, string attributesXml);

        void PostPaymentProcessing(MasterOrder masterOrder);
        ...
        bool CanOrderPrepare(Order order);
        ...
        /// <returns></returns>
        bool IsReadyToReceive(List<Shipment> shipments, Order order);
        ...
        void ReceivedOrder(List<Shipment> shipments, Order order, bool notifyCustomer);
    }
}
