...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        /// <param name="cart">Cart</param>
        /// <returns>Shipping total</returns>
        List<VendorShipping> GetShoppingCartShippingTotalPerVendor(IList<ShoppingCartItem> cart);
        List<VendorDiscount> GetShoppingCartDiscountTotalPerVendor(Customer customer);
        ...
        decimal? GetShoppingCartTotal(IList<ShoppingCartItem> cart,
            ...
            bool? useRewardPoints = null, bool usePaymentMethodAdditionalFee = true);
        decimal? GetShoppingCartTotalByVendor(int vendorId, IList<ShoppingCartItem> cart,
