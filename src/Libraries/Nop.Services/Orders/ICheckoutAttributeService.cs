...
namespace Nop.Services.Orders
{
    ...
    public partial interface ICheckoutAttributeService
    {
        ...
        CheckoutAttribute GetCheckoutAttributeByName(string checkoutAttributeName);
        string GetCheckoutAttributeDeliveryTimeSlot(string attributesXml);
        string GetCheckoutAttributeDeliveryDate(string attributesXml);
