...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        /// Gets a category
        /// </summary>
        /// <param name="categoryIName">Category name</param>
        /// <returns>Category</returns>
        public virtual Category GetCategoryByName(string categoryName)
        {
            ...
            var query = from p in _categoryRepository.Table
                        where categoryName == p.Name && !p.Deleted
                        select p;
        ...
        public virtual string GetFormattedBreadCrumbWithoutMain(Category category, IList<Category> allCategories = null,
            string separator = ">>", int languageId = 0)
        {
            var result = string.Empty;
