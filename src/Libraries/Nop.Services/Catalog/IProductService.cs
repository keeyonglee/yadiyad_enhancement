...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IList<Product> GetProductsByVendorId(int vendorId);
        IList<Product> GetAllProductsDisplayedOnHomepage();
        IList<Product> GetInitialEatsProductsDisplayedOnHomepage();
        IPagedList<Product> GetAllEatsProductDisplayedOnHomePage(int pageIndex,
            int pageSize);
        IList<Product> GetInitialMartProductsDisplayedOnHomepage();
        IPagedList<Product> GetAllMartProductDisplayedOnHomePage(int pageIndex,
            int pageSize);
        /// <summary>
        /// Gets product
        /// </summary>
        ...
        bool CheckIfIsEats(int categoryId);
        bool CheckIfIsMart(int categoryId);
        List<int> GetAllEatsCategory();
        List<int> GetAllMartCategory();

        IPagedList<Product> GetProductsNotApproved(int pageIndex = 0, int pageSize = int.MaxValue, string keyword = null);
        ...
        IList<Product> GetAdditionalProductsByVendorId(int productId, int vendorId = 0);
        ...
        List<int> GetAllChildCategories(int id);
        /// <summary>
        ...
        IList<int> GetProducReviewsPicturesById(int productReviewId);
        ...
        void InsertProductReviewPictureMapping(ProductReviewPictureMapping productReviewPictureMapping);

        bool? CheckBuyerVotedHelpfulness(int productReviewId, int customerId);
