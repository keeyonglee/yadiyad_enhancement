...
namespace Nop.Services.Blogs
{
    ...
    public partial class BlogService : IBlogService
    {
        ...
        private readonly IRepository<BlogPostPictureMapping> _blogPostPictureMappingRepository;
        ...
        public BlogService(CatalogSettings catalogSettings,
            ...
            IRepository<BlogPostPictureMapping> blogPostPictureMappingRepository)
        {
            ...
            _blogPostPictureMappingRepository = blogPostPictureMappingRepository;
        }
            ...
            bool? approved = null, DateTime? fromUtc = null, DateTime? toUtc = null, string commentText = null)
        {
            ...
            query = query.OrderByDescending(comment => comment.CreatedOnUtc);
        ...
        public void InsertBlogPostPictureMapping(BlogPostPictureMapping blogPostPictureMapping)
        {
            if (blogPostPictureMapping == null)
                throw new ArgumentNullException(nameof(blogPostPictureMapping));

            _blogPostPictureMappingRepository.Insert(blogPostPictureMapping);

            //event notification
            _eventPublisher.EntityUpdated(blogPostPictureMapping);
        }
