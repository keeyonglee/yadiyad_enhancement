...
namespace Nop.Services.Common
{
    ...
    public partial interface IPdfService
    {
        ...
        void PrintShuqOrdersToPdf(Stream stream, IList<Order> orders, Vendor vendor, int languageId = 0, int vendorId = 0);

        void PrintShuqVendorInvoiceToPdf(Stream stream, Order order, int languageId = 0);
