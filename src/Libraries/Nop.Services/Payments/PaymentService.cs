...
namespace Nop.Services.Payments
{
    ...
    public partial class PaymentService : IPaymentService
    {
        ...
        public virtual void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            if (postProcessPaymentRequest.MasterOrder.PaymentStatus == PaymentStatus.Paid)
                return;

            var customer = _customerService.GetCustomerById(postProcessPaymentRequest.MasterOrder.CustomerId);
            var paymentMethod = _paymentPluginManager
                .LoadPluginBySystemName(postProcessPaymentRequest.MasterOrder.PaymentMethodSystemName, customer, postProcessPaymentRequest.MasterOrder.StoreId)
                ?? throw new NopException("Payment method couldn't be loaded");
