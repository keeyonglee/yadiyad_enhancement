    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            var crAdministrators = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = NopCustomerDefaults.AdministratorRoleName
            };
            var crForumModerators = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = NopCustomerDefaults.ModeratorRoleName
            };
            ...
            var crGuests = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = NopCustomerDefaults.GuestRoleName
            };
            var crVendors = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = NopCustomerDefaults.VendorRoleName
            };
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new MediaSettings
            {
                ...
                VendorAboutUsPictureSize = 450,
                VendorSliderPictureSize = 450,
            });
