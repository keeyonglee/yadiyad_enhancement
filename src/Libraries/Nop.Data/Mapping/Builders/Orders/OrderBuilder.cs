    ...
    public partial class OrderBuilder : NopEntityBuilder<Order>
    {
        ...
        public override void MapEntity(CreateTableExpressionBuilder table)
        {
            table
                ...
                .WithColumn(nameof(Order.CancellationReason)).AsInt32().NotNullable()
                .WithColumn(nameof(Order.CancellationDateUtc)).AsDateTime().Nullable()
                .WithColumn(nameof(Order.VendorShippingDiscount)).AsDecimal().NotNullable()
                .WithColumn(nameof(Order.PlatformShippingDiscount)).AsDecimal().NotNullable()
                .WithColumn(nameof(Order.PlatformSubTotalDiscount)).AsDecimal().NotNullable()
                ...
                .WithColumn(nameof(Order.MasterOrderId)).AsInt32().NotNullable().ForeignKey<MasterOrder>();
        }
