...
namespace Nop.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        public static bool TryLoadEnvDataSettings(IConfiguration configuration = null)
        {
            if(Singleton<DataSettings>.Instance?.IsValid ?? false)
                return true;
            ...
            try 
            {
                ...
                var connectionConfig = configuration.GetSection("DBConnection");
                connectionConfig.Bind(dataSettings);
