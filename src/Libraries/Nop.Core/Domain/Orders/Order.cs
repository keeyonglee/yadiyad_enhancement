...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        public decimal ActualOrderShippingInclTax { get; set; }

        public decimal ActualOrderShippingExclTax { get; set; }
        ...
        public DateTime? OrderShippingDeliverySlot { get; set; }
        ...
        /// Gets or sets the cancellation reason
        /// </summary>
        public OrderCancellationEnum OrderCancellation
        {
            get => (OrderCancellationEnum)CancellationReason;
            set => CancellationReason = (int)value;
        }
