...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class ReturnRequest : BaseEntity
    {
        ...
        public ReturnStatusEnum ReturnStatusText
        {
            get => (ReturnStatusEnum)ReturnStatus;
            set => ReturnStatus = (int)value;
        }

        /// <summary>
        /// Gets or sets the action after return
        /// </summary>
        public int ActionAfterReturn { get; set; }
        public ActionAfterReturn ActionAfterReturnText
        {
            get => (ActionAfterReturn)ActionAfterReturn;
            set => ActionAfterReturn = (int)value;
        }
    }
}
