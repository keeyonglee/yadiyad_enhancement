...
namespace Nop.Core.Domain.Orders
{
    ...
    public class OrderSettings : ISettings
    {
        ...
        /// <summary>
        /// Number of days after which a return request will be automatically approved without Return
        /// </summary>
        public int DaysForSellerToRespondReturnRequest { get; set; }
        
        /// <summary>
        /// Number of days available for the Seller to Ship the Order
        /// </summary>
        public int DaysForSellerToShipOrder { get; set; }

        public int DaysForBuyerToShipOrder { get; set; }
        public int DaysForSellerToCompleteInspection { get; set; }
    }
}