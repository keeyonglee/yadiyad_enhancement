...
namespace Nop.Core.Domain
{
    ...
    public class StoreInformationSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value of Shuq Seller Guideline URL of the site
        /// </summary>
        public string ShuqSellerGuidelineLink { get; set; }

        /// <summary>
        /// Gets or sets a value of Shuq Seller Guideline URL of the site
        /// </summary>
        public string ShuqContactUsLink { get; set; }
        
        /// <summary>
        /// Gets or sets a value of Shuq Seller App Guideline URL of the site
        /// </summary>
        public string ShuqSellerAppGuidelineLink { get; set; }
    }
}
