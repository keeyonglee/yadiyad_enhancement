...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountProductMapping>
    {
        ...
        /// </summary>
        public int? DeliveryModeId { get; set; } = (int)Catalog.DeliveryMode.Bike;
        ...
        {
            get => (DeliveryMode)(DeliveryModeId ?? (int)Catalog.DeliveryMode.Bike);
            set => DeliveryModeId = (int)(value ?? Catalog.DeliveryMode.Bike);
        }
        ...
        /// <summary>
        /// Gets or sets the product approval status
        /// </summary>
        public ProductApprovalStatus ProductApprovalStatus
        {
            get => (ProductApprovalStatus)ProductApprovalStatusId;
            set => ProductApprovalStatusId = (int)value;
        }

        public string DeliveryDatesJson { get; set; }
        ...
        public List<DateTime> DeliveryDates
        {
            get
            {
                ...
                if (string.IsNullOrWhiteSpace(DeliveryDatesJson) == false)
                {
                    try 
                    {
                        deliveryDates = JsonConvert.DeserializeObject<List<DateTime>>(DeliveryDatesJson);
                    }
                    catch(Exception ex)
                    {
            ...
            set
            {
                ...
                {
                    DeliveryDatesJson = null;
                }
                else
                {
                    DeliveryDatesJson = JsonConvert.SerializeObject(value);
                }
            }
        }
