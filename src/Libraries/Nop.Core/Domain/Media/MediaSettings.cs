...
namespace Nop.Core.Domain.Media
{
    ...
    public class MediaSettings : ISettings
    {
        ...
        /// <summary>
        /// Picture size of vendor aboutus pictures
        /// </summary>
        public int VendorAboutUsPictureSize { get; set; }
        /// <summary>
        /// Picture size of vendor slider pictures
        /// </summary>
        public int VendorSliderPictureSize { get; set; }
        ...
        /// <summary>
        /// Max Number of Images that can be uploaded when reviewing a product
        /// </summary>
        public int MaxReviewImages { get; set; }
    }
}