namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        /// </summary>
        public static string GuestRoleName => "Guest";

        /// <summary>
        /// Gets a system name of 'vendors' customer role
        /// </summary>
        public static string VendorRoleName => "Vendor";

        public static string OperatorRoleName => "Operator";

        public static string OrganizationRoleName => "Organization";

        public static string IndividualRoleName => "Individual";
