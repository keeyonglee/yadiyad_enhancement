...
namespace Nop.Plugin.NopStation.WebApi.Areas.Admin.Models
{
    public class ConfigurationModel : BaseNopModel, ISettingsModel
    {
        ...
        [NopResourceDisplayName("Admin.NopStation.WebApi.Configuration.Fields.EnableCORS")]
        public bool EnableCORS { get; set; }
        public bool EnableCORS_OverrideForStore { get; set; }
        ...
        [NopResourceDisplayName("Admin.NopStation.WebApi.Configuration.Fields.DefaultCategoryIcon")]
        [UIHint("Picture")]
        public int DefaultCategoryIcon { get; set; }
        public bool DefaultCategoryIcon_OverrideForStore { get; set; }
