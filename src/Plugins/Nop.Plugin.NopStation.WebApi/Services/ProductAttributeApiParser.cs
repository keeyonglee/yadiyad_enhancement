...
namespace Nop.Plugin.NopStation.WebApi.Services
{
    public class ProductAttributeApiParser : IProductAttributeApiParser
    {
        ...
        public virtual decimal ParseCustomerEnteredPrice(Product product, NameValueCollection form)
        {
            if (product == null)
        ...
        public virtual string ParseProductAttributes(Product product, NameValueCollection form, List<string> errors)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            if (form == null)
