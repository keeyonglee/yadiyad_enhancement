...
namespace Nop.Plugin.NopStation.WebApi
{
    public class WebApiPlugin : BasePlugin, IWidgetPlugin, IAdminMenuPlugin, IMiscPlugin, INopStationPlugin
    {
        #region Fields
        ...
        private void CreateSampleData()
        {
            try
            {
                var sampleImagesPath = _fileProvider.MapPath("~/Plugins/NopStation.WebApi/Install/");

                var settings = new WebApiSettings()
                {
                    PrimaryThemeColor = WebApiPluginDefaults.PrimaryThemeColor,
                    BottomBarActiveColor = WebApiPluginDefaults.BottomBarActiveColor,
                    BottomBarInactiveColor = WebApiPluginDefaults.BottomBarInactiveColor,
                    BottomBarBackgroundColor = WebApiPluginDefaults.BottomBarBackgroundColor,
                    TopBarBackgroundColor = WebApiPluginDefaults.TopBarBackgroundColor,
                    TopBarTextColor = WebApiPluginDefaults.TopBarTextColor,
                    GradientStartingColor = WebApiPluginDefaults.GradientStartingColor,
                    GradientMiddleColor = WebApiPluginDefaults.GradientMiddleColor,
                    GradientEndingColor = WebApiPluginDefaults.GradientEndingColor,
                    ...
                    DefaultCategoryIcon = _pictureService.InsertPicture(_fileProvider.ReadAllBytes(_fileProvider.Combine(sampleImagesPath, "nop-station.png")), MimeTypes.ImagePng, "nop-station").Id,
                    LogoId = _pictureService.InsertPicture(_fileProvider.ReadAllBytes(_fileProvider.Combine(sampleImagesPath, "nop-station-logo.png")), MimeTypes.ImagePng, "nop-station").Id
                };
                ...
                _sliderService.InsertApiSlider(sliders);

                var filePath = _fileProvider.Combine(_fileProvider.MapPath(sampleImagesPath), "apiStringResources.json");
                ...
                _apiStringResourceService.InsertApiStringResource(appResources);
            }
            catch (Exception ex)
            {
                _logger.Error($"Failed to create web api sample data: {ex.Message}", ex);
            }
        }
        ...
        {
            this.NopStationPluginInstall(new WebApiPermissionProvider());
            CreateSampleData();
            base.Install();
        }
        ...
        {
            this.NopStationPluginUninstall(new WebApiPermissionProvider());
            base.Uninstall();
        }
        ...
        public string GetWidgetViewComponentName(string widgetZone)
        {
            if (widgetZone == AdminWidgetZones.CategoryDetailsBlock)
                return "WebApiCategoryIconAdmin";
            return "";
        }
        ...
        public void ManageSiteMap(SiteMapNode rootNode)
        {
            var menu = new SiteMapNode()
            {
                ...
                Title = _localizationService.GetResource("Admin.NopStation.WebApi.Menu.WebApi")
            };
            ...
            if (_permissionService.Authorize(WebApiPermissionProvider.ManageSlider))
            {
                var slider = new SiteMapNode()
                {
                    ...
                    Url = "/Admin/WebApiSlider/List",
                    Title = _localizationService.GetResource("Admin.NopStation.WebApi.Menu.Sliders"),
            ...
            if (_permissionService.Authorize(WebApiPermissionProvider.ManageCategoryIcon))
            {
                var device = new SiteMapNode()
                {
                    Visible = true,
                    IconClass = "fa-genderless",
                    Url = "/Admin/WebApiCategoryIcon/List",
                    Title = _localizationService.GetResource("Admin.NopStation.WebApi.Menu.CategoryIcons"),
            ...
            if (_permissionService.Authorize(WebApiPermissionProvider.ManageDevice))
            {
                var device = new SiteMapNode()
                {
                    Visible = true,
                    IconClass = "fa-genderless",
                    Url = "/Admin/WebApiDevice/List",
                    Title = _localizationService.GetResource("Admin.NopStation.WebApi.Menu.Devices"),
            ...
            if (_permissionService.Authorize(WebApiPermissionProvider.ManageConfiguration))
            {
                var configure = new SiteMapNode()
                {
                    Visible = true,
                    IconClass = "fa-genderless",
                    Url = "/Admin/WebApi/Configure",
                    Title = _localizationService.GetResource("Admin.NopStation.WebApi.Menu.Configuration"),
            ...
            if (_permissionService.Authorize(WebApiPermissionProvider.ManageConfiguration))
            {
                var documentation = new SiteMapNode()
                {
                    ...
                    Url = "https://www.nop-station.com/web-api-v2-documentation",
                    Visible = true,
                    IconClass = "fa-genderless",
        ...
        public List<KeyValuePair<string, string>> PluginResouces()
        {
            ...
            {
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.DeviceType.IPhone", "iPhone"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.DeviceType.Android", "Android"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.DeviceType.WindowsPhone", "Windows phone"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.DeviceType.Others", "Others"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.SliderType.None", "None"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.SliderType.Product", "Product"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.SliderType.Category", "Category"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.SliderType.Manufacturer", "Manufacturer"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.SliderType.Vendor", "Vendor"),
                new KeyValuePair<string, string>("Enums.Nop.Plugin.NopStation.WebApi.Domains.SliderType.Topic", "Topic"),
                ...
                new KeyValuePair<string, string>("Admin.NopStation.WebApi.Configuration.Fields.EnableCORS", "Enable CORS"),
                new KeyValuePair<string, string>("Admin.NopStation.WebApi.Configuration.Fields.EnableCORS.Hint", "Check to enable CORS. It will add \"Access-Control-Allow-Origin\" header for every api response."),
                ...
                new KeyValuePair<string, string>("Admin.NopStation.WebApi.Configuration.Fields.DefaultCategoryIcon", "Default category icon"),
                new KeyValuePair<string, string>("Admin.NopStation.WebApi.Configuration.Fields.DefaultCategoryIcon.Hint", "The default category icon."),
