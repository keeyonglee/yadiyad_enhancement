...
namespace Nop.Plugin.Widgets.qBoSlider.Models.Admin.WidgetZones
{
    ...
    public partial class WidgetZoneModel : BaseNopEntityModel
    {
        ...
        /// <summary>
        /// Gets or sets minimum slider Height
        /// </summary>
        [NopResourceDisplayName("Nop.Plugin.Baroque.Widgets.qBoSlider.Admin.WidgetZone.Fields.MinSlideWidgetZoneHeight")]
        public int? MinSlideWidgetZoneHeight { get; set; } = null;

        /// <summary>
        /// Gets or sets maximum slider Height
        /// </summary>
        [NopResourceDisplayName("Nop.Plugin.Baroque.Widgets.qBoSlider.Admin.WidgetZone.Fields.MaxSlideWidgetZoneHeight")]
        public int? MaxSlideWidgetZoneHeight { get; set; } = null;
