    ...
    public class qBoWidgetZoneController : BasePluginController
    {
        ...
        public virtual IActionResult Create(WidgetZoneModel model, bool continueEditing)
        {
            ...
            var widgetZone = new WidgetZone()
            {
                ...
                MinSlideWidgetZoneHeight = model.MinSlideWidgetZoneHeight,
                MaxSlideWidgetZoneHeight = model.MaxSlideWidgetZoneHeight,
        ...
        public virtual IActionResult Edit(WidgetZoneModel model, bool continueEditing)
        {
            ...
            widgetZone.MinSlideWidgetZoneHeight = model.MinSlideWidgetZoneHeight;
            widgetZone.MaxSlideWidgetZoneHeight = model.MaxSlideWidgetZoneHeight;
